...
public class CtrlTvaSQL implements Initializable{
	@FXML
	...
	private void creerModele(ActionEvent e){
			...
			DAOFactory.getDAOFactory(Persistance.MYSQL).getTVADAO().create(t);
			...
			t.setLibelle(tf_libelle.getText());
			t.setTaux(Float.parseFloat(tf_taux.getText()));
			DAOFactory.getDAOFactory(Persistance.MYSQL).getTVADAO().update(t);
			this.tblTva.refresh();
	...
	private void supprimerAction(ActionEvent e){
		...
		for(Produit p: DAOFactory.getDAOFactory(Persistance.MYSQL).getProduitDAO().findAll())
		...
		DAOFactory.getDAOFactory(Persistance.MYSQL).getTVADAO().delete(t);
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		this.tblTva.getItems().addAll(DAOFactory.getDAOFactory(Persistance.MYSQL).getTVADAO().findAll());
		btnsupprimer.setDisable(true);
		btnajoute.setDisable(false);
		btnmodifier.setDisable(true);
