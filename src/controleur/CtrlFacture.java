...
public class CtrlFacture implements Initializable{
	@FXML
	...
	private void creerModele(ActionEvent e){
			...
			DAOFactory.getDAOFactory(Persistance.LISTEMEMOIRE).getFactureDAO().create(p);
			...
			p.setIdclient(cbxClient.getSelectionModel().getSelectedItem());
			//DAOFactory.getDAOFactory(Persistance.LISTEMEMOIRE).getFactureDAO().create(p);
			DAOFactory.getDAOFactory(Persistance.LISTEMEMOIRE).getFactureDAO().update(p);
	...
	private void supprimerAction(ActionEvent e){
		...
		DAOFactory.getDAOFactory(Persistance.LISTEMEMOIRE).getFactureDAO().delete(t);
	...
	public void initialize(URL location, ResourceBundle resources) {
		this.cbxClient.setItems(FXCollections.observableArrayList(DAOFactory.getDAOFactory(Persistance.LISTEMEMOIRE).getClientDAO().findAll()));
		...
		this.tblFacture.getItems().addAll(DAOFactory.getDAOFactory(Persistance.LISTEMEMOIRE).getFactureDAO().findAll());
		btnsupprimer.setDisable(true);
		btnajoute.setDisable(false);
		btnmodifier.setDisable(true);
