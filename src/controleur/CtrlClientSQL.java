...
public class CtrlClientSQL implements Initializable{
	@FXML
	...
	private void creerModele(ActionEvent e){
			...
			DAOFactory.getDAOFactory(Persistance.MYSQL).getClientDAO().create(c);
			...
			c.setPays(tf_pays.getText());
			c.setCa(tf_ca.getText());
			DAOFactory.getDAOFactory(Persistance.MYSQL).getClientDAO().update(c);
	...
	private void supprimerAction(ActionEvent e){
		...
		DAOFactory.getDAOFactory(Persistance.MYSQL).getClientDAO().delete(t);
